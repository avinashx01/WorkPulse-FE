        ...
        <Grid container rowSpacing={10} columnSpacing={12}>
          ...
          <Grid item xs={12} sm={3} lg={2}>
            ...
            <div className='flex flex-col gap-4'>
              ...
              <Typography component={Link} href='/pages/misc/under-maintenance' color='white' className='opacity-[78]'>
                Maintenance
              </Typography>
      ...
      {/* <div className='bg-[#211B2C]'>
        ...
        >
          ...
          <div className='flex gap-1.5 items-center'>
            <IconButton component={Link}  href='https://github.com/pixinvent' target='_blank'>
              <i className='tabler-brand-github-filled text-white text-lg' />
            </IconButton>
            <IconButton component={Link}  href='https://www.facebook.com/pixinvents/' target='_blank'>
              <i className='tabler-brand-facebook-filled text-white text-lg' />
            </IconButton>
            <IconButton component={Link}  href='https://x.com/pixinvents' target='_blank'>
